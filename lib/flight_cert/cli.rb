...
module FlightCert
  module CLI
    ...
    create_command 'cert-install' do |c|
      c.summary = 'Use a self-generated SSL certificate'
      c.description = <<~DESC
        Use an SSL certificate that has been generated by the user, independent of Flight Cert.
      DESC
      c.slop.string '--key', 'Specify the path to the key file', required: true
      c.slop.string '--fullchain', 'Specify the path to the fullchain file', required: true
    end
